import 'package:cut_fix/app/booking.dart';

import 'package:flutter/material.dart';
import 'package:video_player/video_player.dart';
import '../components/menubar.dart' as custom_menubar; // Impor MenuBar

class ProfileBarber extends StatefulWidget {
  final Map<String, dynamic> barbershop;

  const ProfileBarber({required this.barbershop, super.key});

  @override
  _ProfileBarberState createState() => _ProfileBarberState();
}

class _ProfileBarberState extends State<ProfileBarber> {
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              const Booking(), // Mengarah ke halaman Booking
                        ),
                      );
                    },
