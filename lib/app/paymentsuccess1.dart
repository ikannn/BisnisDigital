import 'package:cut_fix/app/detailbookingkerumah.dart';
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Pembayaran Booking Ke Rumah Anda Berhasil!',
              style: TextStyle(
                fontSize: 24.0,
                fontWeight: FontWeight.bold,
              ),
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => DetailBookingPage1(
