import 'package:cut_fix/app/detailbookingkerumah1.dart';
import 'package:flutter/material.dart';
import '../components/menubar.dart' as custom_menubar;


class DetailBookingPage1 extends StatelessWidget {
      ...
      child: ElevatedButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => DetailBooking2Page(
