import 'package:cut_fix/app/payment1.dart';
...
class Booking1 extends StatefulWidget {
  ...
  @override
  State<Booking1> createState() => _BookingState1();
}
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              const SizedBox(height: 16.0),
              buildSectionTitle('Alamat Tempat yang Dituju'),
              TextField(
                decoration: InputDecoration(
                  hintText: 'Masukkan alamat tempat tujuan',
                ...
                onPressed: () {
                  ...
                  if (selectedTime != null &&
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => PaymentPage1(
                          ...
                          bill: 'Rp. 50.000',
                          destinationAddress: address!, // Kirim alamat ke payment1.dart
                        ),
                      ),
                    );
                  } else {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text(
                          'Harap lengkapi semua informasi sebelum melanjutkan.',
                        ),
                      ),
                    );
                  }
